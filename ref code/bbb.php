<?php
/*
Template Name: Projects Multiple Plans
*/
?>
<!DOCTYPE html>
<html lang="en">
                            ...
                            <div class="detail_tabs">
                                <div class="detailed_wrapper">
                                    ...
                                    <!-- Unordered list representing the tabs -->
										...
										$count=1; 
			if(get_field('multi_plans')):

				 while(has_sub_field('multi_plans')):?>
                                            <li><a href="#sqft<?php echo $count;?>"><?php the_sub_field('multi_sqft');?> SQFT</a></li>
                                            ...
                                            <div class="row configurations-details">
                                                <div class="col-sm-12">
                                                    <div class="sqft_details">
                                                        <span><?php the_sub_field('multi_sqft');?> Sqft</span>
                                                        <span><?php the_sub_field('multi_price');?></span>
                                                        <span><?php the_sub_field('multi_bhk');?> BHK</span>
                                                         <span><?php the_sub_field('multi_status');?></span>
                                                    </div>
                                                    <div class="enquire_pop">
                                                        <a href="javascript:void(0);" data-toggle="modal" data-target="#enq_pop" onClick="show1('<?php the_sub_field('multi_sqft');?>','<?php the_sub_field('multi_price');?>','<?php the_sub_field('multi_bhk');?>','<?=$post->post_title?>')">Enquire Now</a>
                                                    </div>
                                                    <?
													$i=2;
													...
													foreach(get_sub_field('multi_plan_images') as $resource){
														 //print_r( $resource);
													?>
            ...
            <div class="container">
                ...
                <div class="col-md-2 col-sm-6 col-xs-12 social_foot_wrap">
                    ...
                    <div class="social_foot">
                        <a href="<?=$contact['facebook']?>" class="tw_foot" target="_blank"><i class="fa fa-facebook" aria-hidden="true"></i></a>
        ...
        <div class="container">
            <div class="row">
                <div class="copyrights">
                    Copyright &copy; 2016 . <a href="#">Victoria Realtors</a>
                </div>
